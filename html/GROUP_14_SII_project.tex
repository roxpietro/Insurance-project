...
\setlength{\itemsep}{-1ex}
   ...
   \item Equity
   \item The Bond :
   \item Liabilities \& Own fund :
   \item Stressed Scénarios :
   \item Upward interest rate Scénario:
   \item Downward interest rate Scénario :
   \item SCR IR:
   \item Stressed Equity Scénario :
   \item Stressed spread Scénario :
   \item Stressed mortality Scénario
   \item Stressed lapse Scénario:
   \item CAT Scénario:
   \item LIFE Solvency Capital Requirement:
   \item MARKET Solvency Capital Requirement:
   \item BASIC Solvency Capital Requirement
\end{itemize}
\begin{verbatim}
%GROUP 7 SII project
...
\subsection*{Liabilities \& Own fund :}
...
\subsection*{Stressed Scénarios :}



\subsection*{Upward interest rate Scénario:}
...
\subsection*{Downward interest rate Scénario :}
...
\subsection*{Stressed Equity Scénario :}

\begin{verbatim}
% we add the symmetric adjustment
Equity_shock_type1=0.39 + 0.036;
...
\subsection*{Stressed spread Scénario :}
...
\subsection*{Stressed mortality Scénario}
...
\subsection*{Stressed lapse Scénario:}
...
\subsection*{LIFE Solvency Capital Requirement:}
...
\subsection*{MARKET Solvency Capital Requirement:}
...
\subsection*{BASIC Solvency Capital Requirement}
